...
public class NotificationController {
  ...
  public ApiResponse<NotificationListResponse> getNotifications(
    ...
    return ApiResponse.of(
        ...
        notificationService.getNotifications(AuthenticatedUser.from(authentication)));
  }
  ...
  public ApiResponse<NotificationDetailResponse> getNotification(
    ...
    return ApiResponse.of(
        ...
        notificationService.getNotification(AuthenticatedUser.from(authentication), notificationId));
  }
  ...
  public ApiResponse<Void> markAsRead(
      @Parameter(hidden = true) Authentication authentication,
      @Parameter(description = "알림 ID", example = "1") @PathVariable String notificationId) {
    notificationService.markAsRead(AuthenticatedUser.from(authentication), notificationId);
